...
*/
'use strict';(function(Y,cb){"object"===typeof exports&&"undefined"!==typeof module?module.exports=cb(require("wp-includes/js/dist/vendor/react")):"function"===typeof define&&define.amd?define(["wp-includes/js/dist/vendor/react"],cb):Y.ReactDOM=cb(Y.React)})(this,function(Y){function cb(a, b, c, d, e, f, g, h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var k=[c,d,e,f,g,h],l=0;a=Error(b.replace(/%s/g,function(){return k[l++]}));a.name=
